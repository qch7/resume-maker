...
test("course headings are deduplicated in both levels without changing stored titles", /* 验证子栏目与大栏目都只保留一层同名标题，不误删不同条目标题。 */ () => {
...
test("reordering a major section carries its children without changing their content", /* 验证大栏目排序与子栏目归属独立，并保持原数据不变。 */ () => {
