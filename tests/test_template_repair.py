...
from resume_maker.services.template_analysis import complete_labels
...
def test_ai_repairs_its_own_missing_fields(catalog, tmp_path):
    """首轮遗漏会自动反馈给 AI，完整结果才显示为可试填，并不传当前资料值。"""
